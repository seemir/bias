...
\caption[K-Means clustering HFmrEF based on post-diagnosis]{Baseline characteristics of K-Means clustering HFmrEF based on post-diagnosis}\label{tab:baseline_char_phy_mr_km}\\
\toprule
