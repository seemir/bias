...
\begin{figure}[h!]
    ...
    \caption[Clustering results: HFmrEF with Post-Diagnosis]{\textit{Clustering results of HFmrEF with Post-Diagnosis}}
...
\begin{figure}[h!]
    ...
    \caption[Clustering results: HFpEF without Post-Diagnosis]{\textit{Clustering results of HFpEF \textit{without} Post-Diagnosis}}
