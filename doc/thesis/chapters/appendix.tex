...
\input{doc/thesis/tables/results_clustering_detail.tex}
...
\begin{figure}[h!]
    ...
    \caption[Clustering results of HFmrEF with Post-Diagnosis]{\textit{Clustering results of HFmrEF with Post-Diagnosis}}
...
\begin{figure}[h!]
    ...
    \caption[Clustering results of HFpEF without Post-Diagnosis]{\textit{Clustering results of HFpEF \textit{without} Post-Diagnosis}}
