...
\begin{titlepage}
\begin{center}
\vspace*{0,25cm}\Large{\textbf{On the Application of Machine Learning Techniques for Phenotypic Clustering and Classification of Heart Failure Patients}}\\[0,4cm]
