% Created by tikzDevice version 0.11 on 2018-05-09 14:33:43
...
\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (558.22,277.05) rectangle (674.70,240.84);

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (575.62,261.54) {Number comp: 51};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (575.62,249.46) {Cum.variance: 0.9533};
\end{scope}
\end{tikzpicture}
