...
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (267,203) -- (290,203) ;
\draw [shift={(290,203)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ] [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- (8.93,-4.29)    ;
...
\draw    (164.8,203.2) -- (265,203) ;


\draw    (165.5,97) -- (165.8,202.2) ;


\draw    (131.5,97) -- (165.5,97) ;
...
\draw    (83.5,204) -- (83.5,232) ;
\draw [shift={(83.5,232)}, rotate = 270] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ] [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- (8.93,-4.29)    ;
...
\mathbf{Clustering}
\end{gathered}$};
\draw (82,364) node [scale=0.7]  {$ \begin{gathered}
\mathbf{Expectation}\\
\mathbf{Maximization}
\end{gathered}$};
