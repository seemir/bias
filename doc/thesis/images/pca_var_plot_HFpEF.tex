% Created by tikzDevice version 0.11 on 2018-05-09 14:33:13
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (575.62,261.54) {Number comp: 59};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (575.62,249.46) {Cum.variance: 0.9508};
\end{scope}
\end{tikzpicture}
