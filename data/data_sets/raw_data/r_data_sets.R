...
#--------------------------------------------------------------------
# Save the matrises as .Rdat
#--------------------------------------------------------------------
save(HFpEF_matrix, file='data_use_HFpEF_matrix.Rdat')
save(HFmrEF_matrix, file='data_use_HFmrEF_matrix.Rdat')

#--------------------------------------------------------------------
# Re-code patient groups labels
#--------------------------------------------------------------------
# Get patient groups
#--------------------------------------------------------------------
patient_groups_HFpEF <- as.matrix(unlist(data_set_HFpEF$Patient.group))
patient_groups_HFmrEF <- as.matrix(unlist(data_set_HFmrEF$Patient.group))
...
#--------------------------------------------------------------------
colnames(HFmrEF_outcomes_matrix) <- colnames(HFpEF_outcomes_matrix)<- 
